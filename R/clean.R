...
#' clean(input_df, mest_df, reverse_code, interactive, log)      
 ...
 clean<-function(input_df, mest_df, reverse_code, interactive, log){    
      ...
      Qs_ignore = c("QM02", "QM04", "QC01", "QC02", "QC03", "QC30", "QC32", "QS02", "QS03", "QS05", "QS08", "QS10", "QS12", "QS13", "QS15", "QS22", "QS26", "QS27", "QS28", "QS31", "QS32", "QS34", "QS37", "QS39", "QS40", "QS42", "QS47", "QS48", "QS49", "QS54", "QS56", "QS59")
      j_ignore = which(names(input_df) %in% Qs_ignore)
      if (length(j_ignore)>0){
        log[[length(log)+1]] = paste("\n* Warning: The following variables will be ignored: ", paste(names(input_df)[j_ignore], collapse = ", "), sep = "")
